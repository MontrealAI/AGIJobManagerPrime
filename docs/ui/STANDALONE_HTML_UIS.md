...
- **Primary operator runbook for the documented mainnet artifact (`v42`):** [GENESIS_JOB_MAINNET_HTML_UI.md](./GENESIS_JOB_MAINNET_HTML_UI.md)
...
For the canonical `v42` artifact:
...
2. Prefer local HTTP serving for browser compatibility:
   ...
   ```
3. Open: `http://127.0.0.1:8000/agijobmanager_genesis_job_mainnet_2026-03-05-v42.html`.
