...
2. Versioned standalone HTML artifacts for direct browser use, including:
   - `agijobmanager_genesis_job_mainnet_2026-03-05-v41.html`
...
- Need a **single-file, versioned mainnet interface artifact** for review/operator workflows: use `agijobmanager_genesis_job_mainnet_2026-03-05-v41.html` and the runbook at `../docs/ui/GENESIS_JOB_MAINNET_HTML_UI.md`.
...
For operator instructions in this repository, `v41` is the explicit standalone artifact documented in:
...
- Treat `v41` as a versioned mainnet snapshot with embedded addresses.
